...
def prepare(t5: HFEmbedder, clip: HFEmbedder, img: Tensor, prompt: str | list[str], global_prompt: str | list[str] = None) -> dict[str, Tensor]:
    bs, c, h, w = img.shape
...
def denoise(
    ...
    condition_image: Tensor | None = None,   # for image2image adapter
    ...
    for t_curr, t_prev in zip(timesteps[:-1], timesteps[1:]):
        ...
        pred = model(
            ...
            ip_scale=ip_scale, 
            x_cond=condition_image, # for image2image adapter
